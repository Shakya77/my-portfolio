...
const servicesData: Service[] = [
    {
        ...
        icon: <Code className="h-8 w-8 text-[#eb5d3a]  " />,
    ...
    },
    {
        ...
        icon: <Smartphone className="h-8 w-8 text-[#eb5d3a]  " />,
    ...
    },
    {
        ...
        icon: <Server className="h-8 w-8 text-[#eb5d3a]  " />,
    ...
    },
    {
        ...
        icon: <Database className="h-8 w-8 text-[#eb5d3a]  " />,
    ...
    },
    {
        ...
        icon: <Zap className="h-8 w-8 text-[#eb5d3a]  " />,
